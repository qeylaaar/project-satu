    ...
    <div class="navbar-box">
      <ul class="navbar-list">
        ...
        <?php if (!isset($_SESSION['login'])) { ?>
          <li><a href="./auth/mitra"><i class="fa-solid fa-people-group"></i> Kemitraan</a></li>
    ...
    <div class="header-content">
      <div class="row">
        <div class="col-md-5 my-auto mx-auto" data-aos="fade-right">
          <h2>Twee Coffee</h2>
          <p>
            Twee Coffee menggunakan aplikasi belanja online berbasis web.
        ...
        <div class="col-md-6 my-auto mx-auto" data-aos="zoom-in">
          <div class="d-flex justify-content-center align-items-center flex-column">
            <img src="assets/img/logotwee.jpg" alt="banner" class="my-5">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-5 my-3 mx-auto" data-aos="fade-in">
          ...
          <p class="d-block font-weight-light text-light">
            Twee Coffee menggunakan aplikasi berbelanja online dengan fasilitas memadai
          </p>
        </div>
      </div>
      <div class="row">
