  ...
  <div class="container mt-5">
    ...
    <?php foreach ($myCart as $cartItem) : ?>
        <tr>
            ...
            <td><?= htmlspecialchars($cartItem['product_stok']) ?></td>
            <td>Rp.<?= number_format($cartItem['product_price'], 0, ',', '.') ?></td>
            <td>
                <form action="" method="post">
                    <input type="hidden" name="cart_id" value="<?= htmlspecialchars($cartItem['keranjang_id']) ?>">
                    <input type="number" name="qty" class="form-control" value="<?= htmlspecialchars($cartItem['qty']) ?>">
                    <?php
                    ...
                    <td>Rp.<?= $sub_total2 ?></td>
                    <td>
                        <button class="btn btn-warning" type="submit" name="update"><i class="fas fa-edit"></i></button>
...
<a href="./checkout?cart-id=<?= htmlspecialchars($cartItem['keranjang_id']) ?>" class="btn btn-success float-right">CheckOut</a>
