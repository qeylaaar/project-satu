...
class Config
{
     ...
     * @static
     */
    public static $serverKey = 'SB-Mid-server-0qxpwUd3DzeA06abJvLj3mD7'; // Tambahkan Server Key Anda di sini
    /**
     * Your merchant's client key
     * 
     * @static
     */
    public static $clientKey = 'SB-Mid-client-OQfbwMkq6VjWhDCd'; // Tambahkan Client Key Anda di sini
    /**
     * True for production
