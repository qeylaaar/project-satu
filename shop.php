          ...
          <div class="col-md-4" data-aos="zoom-in">
            <div class="card-custom">
              <div class="card-custom-header">
                <img src="./img/<?= $produk['product_thumb'] ?>" alt="" class="img-custom">
              </div>
              <div class="card-custom-body d-flex justify-content-between">
                <div class="card-custom-text my-auto">
                  <h4 class="m-0"><?= $produk['product_name'] ?></h4>
                  <span class="d-block font-weight-bold mb-3">Rp.<?= $produk['product_price'] ?></span>
                </div>
                <?php if (isset($_SESSION['login'])) { ?>
                  <p onclick="addToCart(<?= $produk['product_id'] ?>, 1, <?= $user_id ?>)" style="cursor: pointer;" class="button button-purple my-4"><i class="fas fa-shopping-cart"></i> Add to cart</p>
                <?php } else { ?>
  ...
  <section class="footer bg-dark" id="contact">
    <div class="footer-content">
      ...
      <div class="row">
        ...
        <div class="col-md-5 my-3 mx-auto" data-aos="fade-in">
          <h4 class="text-light text-poppins font-weight-bold">Twee Coffee</h4>
          <p class="d-block font-weight-light text-light">
            Twee Coffee menggunakan aplikasi berbelanja online berbasis website
          </p>
        </div>
      </div>
      <div class="row">
