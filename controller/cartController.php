...
{
    global $conn;
    $sql = "SELECT * FROM tb_keranjang INNER JOIN tb_product ON tb_keranjang.product_id = tb_product.product_id WHERE tb_keranjang.user_id = '$id' AND tb_keranjang.is_payed = '2' LIMIT 50";
