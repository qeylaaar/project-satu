...
function addTransaksi($data)
{
    ...
    if (mysqli_affected_rows($conn) > 0) {
        mysqli_query($conn, "INSERT INTO `tb_transaksi`(`transaksi_id`, `user_id`, `bank_id`, `keranjang_grup`, `transaksi_alamat`, `tanggal_transaksi`, `status_pembayaran`, `bukti_pembayaran`) VALUES (null,'$user_id','$bank_id','$keranjang_id','$alamat_pembeli','$tglTransaksi',DEFAULT,DEFAULT)");
