                ...
                <table>
                    ...
                    <?php foreach ($produk as $product) : ?>
                        <tr>
                            ...
                            <td><img src="../../img/<?= $product['product_thumb'] ?>" style="width: 100px;"></td>
                            <td><?= $product['product_price'] ?></td>
                            <td><?= $product['product_stok'] ?></td>
                            <td>
                                <a href="./update-produk?id=<?= $product['product_id'] ?>">edit</i></a>
                                <a href="./hapus-produk?id=<?= $product['product_id']; ?>">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
