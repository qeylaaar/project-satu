...
function tambah($data)
{
    ...
    $query = "INSERT INTO `tb_stok` (nama_produk, desc_stok, thumbnail_stok, stok_produk, harga_produk) VALUES ('$product_name', '$product_description', '$product_image', '$stock_product', '$product_price')";
...
function update($data)
{
    ...
    $query = "UPDATE `tb_stok` SET `nama_produk`='$product_name',`desc_stok`='$product_description',`thumbnail_stok`='$gambar',`stok_produk`='$stock_product',`harga_produk`='$product_price' WHERE id_stok = '$id'";
