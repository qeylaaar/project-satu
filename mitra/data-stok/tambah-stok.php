            ...
            <div class="page-content">
                <div class="form-grup" style="margin-top: 1rem;">
                    <form action="" method="POST" enctype="multipart/form-data" style="height: 100%;">
                        ...
                        <input type="text" id="harga_produk" name="harga_produk" placeholder="Harga Produk" class="input" required>
                        <label class="custom-file-upload">
                            <input type="file" name="gambar" id="gambar" />
                            <span style="float: right;">Gambar Produk</span>
                        </label>
                        <input type="text" id="desc_produk" name="desc_produk" placeholder="Deskripsi Produk" class="input" required>
                        <input type="number" id="stok_produk" name="stok_produk" placeholder="Stok Produk" class="input" required>
